        ...
        <View style={!mode ? HomeS.all : HomeS.allBlack}>
            <View style={HomeS.container}>
                <View style={HomeS.header}>
                    <View>
                        <Text style={!mode ? HomeS.h1 : HomeS.h1Black}>Linkage</Text>
                    </View>
                    <View style={HomeS.row}>
                        <TouchableOpacity onPress={() => setMode(!mode)}>
                            {
                                !mode ? <Icon name="moon" size={30} color="black" style={{ marginRight: 15 }} /> : <Icon name="moon-outline" size={30} color="white" style={{ marginRight: 15 }} />
                            }
                        </TouchableOpacity>
                        <TouchableOpacity>
                            {
                                !mode ? <Icon name="heart-outline" size={30} color="black" style={{ marginRight: 15 }} /> : <Icon name="heart-outline" size={30} color="white" style={{ marginRight: 15 }} />
                            }
                        </TouchableOpacity>
                        <TouchableOpacity>
                            {
                                !mode ? <Icon name="add-circle-outline" size={30} color="black" style={{ marginRight: 15 }} /> : <Icon name="add-circle-outline" size={30} color="white" style={{ marginRight: 15 }} />
                            }
                        </TouchableOpacity>
